            ...
            <div class="row mb-5">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Lacoste</a></h3>
                    <p class="mb-0">Zapatos Casuales</p>
                    <p class="text-primary font-weight-bold">$135000</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="/img/cloth_2.jpg" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Tommy Hilfiger</a></h3>
                    <p class="mb-0">Camisa tipo Polo</p>
                    <p class="text-primary font-weight-bold">$40000</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="/img/cloth_3.jpg" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Le Coc</a></h3>
                    <p class="mb-0">Zapatos Casuales</p>
                    <p class="text-primary font-weight-bold">$50000</p>
                  </div>
                </div>
