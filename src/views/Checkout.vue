        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <label for="c_address" class="text-black">Dirección de Residencia <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="c_address" name="c_address" placeholder="Ejemplo: Calle 12 av 12 Barrio Los Alpes">
                </div>
              </div>
                  ...
                  <div class="py-2">
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="c_diff_address" name="c_diff_address" placeholder="Ejemplo: Calle 12 av 12 Barrio Los Alpes">
                      </div>
                    </div>
              ...
              <div class="form-group">
                <label for="c_order_notes" class="text-black">Notas para el Pedido</label>
                <textarea name="c_order_notes" id="c_order_notes" cols="30" rows="5" class="form-control" placeholder="Escriba una descripción aquí..."></textarea>
              </div>
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='thankyou.html'">Realizar Pedido</button>
                  </div>
                </div>
              </div>
            </div>
